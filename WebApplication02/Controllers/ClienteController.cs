...
namespace WebApplication02.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClienteId,Nome,Endereco")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClienteId,Nome,Endereco")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
